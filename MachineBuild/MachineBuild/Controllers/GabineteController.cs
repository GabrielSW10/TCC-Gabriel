...
namespace MachineBuild.Controllers
{
    public class GabineteController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Nome,Descricao,Marca,PrecoMedio,ConsumoWatts")] Gabinete gabinete)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nome,Descricao,Marca,PrecoMedio,ConsumoWatts")] Gabinete gabinete)
        {
            if (ModelState.IsValid)
            {
