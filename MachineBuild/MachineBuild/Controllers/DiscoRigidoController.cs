...
namespace MachineBuild.Controllers
{
    public class DiscoRigidoController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Nome,Descricao,Marca,PrecoMedio,ConsumoWatts,Link")] DiscoRigido discoRigido)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nome,Descricao,Marca,PrecoMedio,ConsumoWatts,Link")] DiscoRigido discoRigido)
        {
            if (ModelState.IsValid)
            {
