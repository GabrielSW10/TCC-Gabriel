...
namespace MachineBuild.Controllers
{
    public class CpuCoolerController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Nome,Descricao,Marca,PrecoMedio,ConsumoWatts,Link")] CpuCooler cpuCooler)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nome,Descricao,Marca,PrecoMedio,ConsumoWatts,Link")] CpuCooler cpuCooler)
        {
            if (ModelState.IsValid)
            {
