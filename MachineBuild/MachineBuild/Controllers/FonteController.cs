...
namespace MachineBuild.Controllers
{
    public class FonteController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Nome,Descricao,Marca,PrecoMedio,Watts")] Fonte fonte)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nome,Descricao,Marca,PrecoMedio,Watts")] Fonte fonte)
        {
            if (ModelState.IsValid)
            {
