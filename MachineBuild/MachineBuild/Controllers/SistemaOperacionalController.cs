...
namespace MachineBuild.Controllers
{
    public class SistemaOperacionalController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Nome,Descricao,Marca,PrecoMedio,ConsumoWatts")] SistemaOperacional sistemaOperacional)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nome,Descricao,Marca,PrecoMedio,ConsumoWatts")] SistemaOperacional sistemaOperacional)
        {
            if (ModelState.IsValid)
            {
