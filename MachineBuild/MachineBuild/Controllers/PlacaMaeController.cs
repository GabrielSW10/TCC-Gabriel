...
namespace MachineBuild.Controllers
{
    public class PlacaMaeController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Nome,Descricao,Marca,PrecoMedio,ConsumoWatts")] PlacaMae placaMae)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nome,Descricao,Marca,PrecoMedio,ConsumoWatts")] PlacaMae placaMae)
        {
            if (ModelState.IsValid)
            {
